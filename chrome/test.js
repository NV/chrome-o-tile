...
test(function Window_get(){
	...
	equals(14, WindowsDict.prototype.get.call(ids, 14).id);
	equals(15, WindowsDict.prototype.get.call(ids, 15).id);
	equals(3,  WindowsDict.prototype.get.call(ids,  3).id);
});
...
test(function Window_add(){
	...
	WindowsDict.prototype.add.call(ids, {id: 23});
	equals(5, ids.length);
	WindowsDict.prototype.add.call(ids, {id: 42});
	equals(23, ids[4].id);
	equals(42, ids[5].id);
	equals(6, ids.length);
});
...
test(function Window_remove(){
	...
	WindowsDict.prototype.remove.call(ids, 13);
	equals(2, ids.length);
	ok(!ids[2], 'Deleted');
	equals(11,  ids[0].id);
	equals(131, ids[1].id);
